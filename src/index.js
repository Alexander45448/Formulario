...
class DataTable extends React.Component {
    ...
    renderRows() {
        return this.state.tableRows.map((row) => {
            ...
            return ( <
                ...
                td > { row.late } < /td> <
                td > < button value = { uniqueKey }
                className = "btn"
                className = "btn-danger" > Drop < /button></td >
                <
                /tr>
            )
        })
    ...
    render() {
        return ( <
            ...
            /tr> <
            /thead> <
            tbody id = "table_body" > { this.renderRows() } <
            /tbody> <
            /table> <
            /section> <
            /div>
...
class MainForm extends React.Component {
    ...
    renderInput() {
        return ( <
            ...
            className = "col-sm-2 col-form-label" > Ingrese el carnet: < /label> <
            br / >
            <
    ...
    renderSwitch() {
        return ( <
            ...
            htmlFor = "late_switch" > Llegó tarde ? < /label> <
            /div> <
            /div>
        );
    }
    ...
    render() {
        return ( <
            ...
            br / >
            <
            div className = "jumbotron" > { this.renderH1("Registro de laboratorio") } { this.renderInput() } {
            ...
            } { this.renderSwitch() } { this.renderInsertButton() } <
            /div> <
            /div>
        );
    }
